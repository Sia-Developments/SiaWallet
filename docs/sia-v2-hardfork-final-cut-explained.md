...
The fork also replaced legacy 28-word Sia seeds with standard 12-word BIP39 seeds, and it permanently broke Sia-UI, whose transaction format isn't valid under the new rules.
