...
A common question after the Sia v2 hardfork was simply "when is Ledger support actually working properly for Siacoin?" As of Sia Wallet v2.12.0, the answer is: natively, over USB or Bluetooth, with no experimental browser flags. Here's the full pairing process.
